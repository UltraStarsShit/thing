	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			if(FlxG.sound.music == null) {
				FlxG.sound.playMusic(Paths.music('BallsMenu'), 0);
		...
		backgroundTitle = new FlxSprite().loadGraphic(Paths.image('BallsMenuYel'));
